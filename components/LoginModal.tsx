            ...
            <div className="p-6 flex flex-col bg-neutral-900">
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                  <div>
                    <label htmlFor="email" className="lime-accent text-xs font-medium block mb-1">
                      EMAIL
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label htmlFor="password" className="lime-accent text-xs font-medium">
                        PASSWORD
                      </label>
                      <button
                        type="button"
                        onClick={() => setShowForgotPassword(true)}
                        className="lime-accent text-xs hover:text-neutral-300"
                      >
                        Forgot?
                      </button>
                    </div>
                  ...
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      id="remember"
                      className="w-4 h-4 bg-neutral-800 border-neutral-700 rounded mr-2 accent-[#ddf928]"
                    />
